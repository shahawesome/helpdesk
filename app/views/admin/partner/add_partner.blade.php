...
<form class="form-horizontal" action="/admin/partner/add" method="post">
	...
	<div class="form-group">
		<label  class="col-sm-3 control-label no-padding-right" for="form-field-1" >Partner Address</label>
