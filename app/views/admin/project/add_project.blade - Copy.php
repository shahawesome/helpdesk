...
<form class="form-horizontal" action="/admin/project/create-project" method="post">
	...
	<div class="form-group">
		<div>
			<label class="col-sm-3 control-label no-padding-right" >Project Director</label> 
		</div>
		<div class="col-sm-8" style="margin-left:9px">
			<input type="text" class="col-xs-10 col-sm-7" placeholder="Project Director" required name="project_director">
		</div>
	</div>
	<div class="form-group">
		<div>
			<label class="col-sm-3 control-label no-padding-right">Project Type</label>
		</div>
		<div class="col-sm-4" style="margin-left:9px">
			<select class="col-xs-10 col-sm-7" required name="type">
